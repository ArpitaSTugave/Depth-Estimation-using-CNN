...
def load_StereoImages(dirpath='C:/Users/arpit/Documents/Python Scripts/depth-estimation'):
    # load training data
    X , X_left,X_right, y =[], [], [], []
    n = 0
...
X_train,X_left_train,X_right_train, y_train, X_val,X_left_val,X_right_val, y_val = main(num_epochs=45)
